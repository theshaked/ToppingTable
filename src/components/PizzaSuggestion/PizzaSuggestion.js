...
const pizzaData = [{name:"Boi",lastname:"LastBoi",amount:3,musthave:"mushroom",optional:"Extra Cheese"},
{name:"Shaked",lastname:"Sibony",amount:3,musthave:"Extra Cheese",optional:"Olives"},
{name:"Einav",lastname:"Schved",amount:2,musthave:"mushroom",optional:"Olives"},
{name:"Piña",lastname:"Colada",amount:4,musthave:"mushroom",optional:"Olives"},
...
const groupAndSum = pizzaData => {
  ...
  const items = Object.entries(result).map(([musthave, { amount }]) => (
    <h1 key={musthave}>Amount of {musthave}: {amount}</h1>
  ));
  

const PizzaSuggestion = () => {

    return <div className='pizza-suggestion'>
